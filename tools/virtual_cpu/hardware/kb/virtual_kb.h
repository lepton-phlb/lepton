...
int virtual_new_kb_init(void *vc, void * data,
                        gint (*pfn)(GtkWidget *widget, GdkEventButton * event,
                                    gpointer user_data));

//
int virtual_kb_create_button(GtkBuilder *builder, GtkWidget ** button_list, int size,
                             kb_layout_t *kb_values,
                             gint (*pfn)(GtkWidget *widget, GdkEventButton * event,
                                         gpointer user_data));
#endif /* VIRTUAL_KB_H_ */
