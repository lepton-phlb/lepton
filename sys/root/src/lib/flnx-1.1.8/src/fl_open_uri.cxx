//
// "$Id: fl_open_uri.cxx,v 1.1 2009-07-15 13:23:30 jjp Exp $"
//
  ...
  while (waitpid(pid, &status, 0) < 0) {
    if (errno != EINTR) {
      // Someone else grabbed the child status...
       //tauon
      if (msg) snprintf(msg, msglen, "waitpid(%ld) failed ..", (long)pid);
         /*snprintf(msg, msglen, "waitpid(%ld) failed: %s", (long)pid,
                        strerror(errno));*/
...
//
// End of "$Id: fl_open_uri.cxx,v 1.1 2009-07-15 13:23:30 jjp Exp $".
//
