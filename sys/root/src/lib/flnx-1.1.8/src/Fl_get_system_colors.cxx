//
// "$Id: Fl_get_system_colors.cxx,v 1.1 2009-07-15 13:23:29 jjp Exp $"
//
...
#if defined(WIN32) || defined(__APPLE__)  || defined(NANO_X)
...
void Fl::get_system_colors()
{
  ...
  if (!key1) key1 = "fltk";
  GR_COLOR  col;
  col = GrGetSysColor(GR_COLOR_APPWINDOW);
  /*TODO*/
  if (!fl_bg2_set) background2(0xff, 0xff, 0xff);
  if (!fl_fg_set) foreground(0, 0, 0);
  if (!fl_bg_set) background(0xd8, 0xd8, 0xd8);
...
//
// End of "$Id: Fl_get_system_colors.cxx,v 1.1 2009-07-15 13:23:29 jjp Exp $".
//
