//
// "$Id: Fl_lock.cxx,v 1.2 2010-03-05 09:34:01 jjp Exp $"
//
...
void Fl::awake(void* msg) {
  write(thread_filedes[1], (void*)&msg, (size_t)sizeof(void*));
}
...
static void thread_awake_cb(int fd, void*) {
  read(fd,(void*) &thread_message_, (size_t)sizeof(void*));
...
void Fl::lock() {
  if (!thread_filedes[1]) {
    ...
    // conditions (STR #1537)
    fcntl(thread_filedes[1], F_SETFL,fcntl(thread_filedes[1], F_GETFL) | O_NONBLOCK);
...
//
// End of "$Id: Fl_lock.cxx,v 1.2 2010-03-05 09:34:01 jjp Exp $".
//
