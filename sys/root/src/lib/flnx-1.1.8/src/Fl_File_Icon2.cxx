//
// "$Id: Fl_File_Icon2.cxx,v 1.1 2009-07-15 13:23:28 jjp Exp $"
//
...
//              fti, strerror(errno));
     Fl::error("Fl_File_Icon::load_fti(): Unable to open \"%s",
                   fti);
    return -1;
  }
...
//
// End of "$Id: Fl_File_Icon2.cxx,v 1.1 2009-07-15 13:23:28 jjp Exp $".
//
