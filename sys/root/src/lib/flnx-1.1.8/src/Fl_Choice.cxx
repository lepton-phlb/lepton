//
// "$Id: Fl_Choice.cxx,v 1.1 2009-07-15 13:23:28 jjp Exp $"
//
...
void Fl_Choice::draw() {
  ...
  if (mvalue()) {
    ...
    if ( Fl::scheme()) {
      ...
      l.deimage = 0;
      l.type = m.labeltype_;
      l.font = m.labelsize_ || m.labelfont_ ? m.labelfont_ : fntidx(textfont());
...
//
// End of "$Id: Fl_Choice.cxx,v 1.1 2009-07-15 13:23:28 jjp Exp $".
//
