//
// "$Id: fl_cursor.cxx,v 1.1 2009-07-15 13:23:30 jjp Exp $"
//
...
void Fl_Window::cursor(Fl_Cursor c, Fl_Color fg, Fl_Color bg) {
  if (!shown()) return;
  Cursor xc;
  uchar fg_r, fg_g, fg_b, bg_r, bg_g, bg_b; // for NANO_X
#ifndef NANO_X
  int deleteit = 0;
#endif
  if (c == FL_CURSOR_DEFAULT) {
...
//
// End of "$Id: fl_cursor.cxx,v 1.1 2009-07-15 13:23:30 jjp Exp $".
//
