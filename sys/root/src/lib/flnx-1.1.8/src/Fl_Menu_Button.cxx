//
// "$Id: Fl_Menu_Button.cxx,v 1.1 2009-07-15 13:23:30 jjp Exp $"
//
...
int Fl_Menu_Button::handle(int e) {
  ...
  case FL_KEYBOARD:
    if (!box()) return 0;
    if (Fl::event_key() == FL_Enter &&	// vovan888: change ' ' to FL_Enter to activate popup
...
//
// End of "$Id: Fl_Menu_Button.cxx,v 1.1 2009-07-15 13:23:30 jjp Exp $".
//
