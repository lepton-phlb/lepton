//
// "$Id: Fl_Shared_Image.cxx,v 1.1 2009-07-15 13:23:29 jjp Exp $"
//
...
Fl_Shared_Image::reload() {
  ...
  char     header[64]; // Buffer for auto-detecting files
  ...
  if (memcmp(header, "#define", 7) == 0) // XBM file
    ...
    for (i = 0, img = 0; i < num_handlers_; i ++) {
      img = (handlers_[i])(name_, (uchar *)header, sizeof(header)); //tauon
...
//
// End of "$Id: Fl_Shared_Image.cxx,v 1.1 2009-07-15 13:23:29 jjp Exp $".
//
