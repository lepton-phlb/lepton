//
// "$Id: Fl_visual.cxx,v 1.1 2009-07-15 13:23:28 jjp Exp $"
//
...
#elif defined(NANO_X)
int Fl::visual(int flags) {
//  printf("Support FL::visual ,now!! in file(Fl_visul.cxx)\n");
  return 0;
}
...
//
// End of "$Id: Fl_visual.cxx,v 1.1 2009-07-15 13:23:28 jjp Exp $".
//
