//
// "$Id: Fl.cxx,v 1.1 2009-07-15 13:23:28 jjp Exp $"
//
...
#ifdef NANO_X
      if (i->region) {GrDestroyRegion(i->region); i->region = 0;}
#else
...
//
// End of "$Id: Fl.cxx,v 1.1 2009-07-15 13:23:28 jjp Exp $".
//
