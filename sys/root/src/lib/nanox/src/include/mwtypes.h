...
#define MWFONT_GUI_VAR		 "Helvetica" //"Helvetica"//"System"	/* deprecated (was "Helvetica")*/
#define MWFONT_OEM_FIXED	"Terminal" //"Terminal"//"SystemFixed"	/* deprecated (was "Terminal")*/

/*Metrix fonts add from 10/2009*/
#ifdef FONT_MEDIUM
#define MWFONT_FIXED_MEDIUM_ENABLE  1
#endif
#ifdef FONT_MEDIUM_JA
#define MWFONT_FIXED_MEDIUM_JA_ENABLE  1
#endif
#ifdef FONT_METRIX_SYMBOLS
#define MWFONT_METRIX_SYMBOLS_ENABLE  1
#endif
/*Metrix add fonts from 05/10/2010*/
#ifdef FONT_VERA
#define MWFONT_VERA_ENABLE 1
#endif
#ifdef FONT_VERA_BD
#define MWFONT_VERA_BD_ENABLE 1
#endif

#ifdef FONT_ARIAL_UNICODE
#define  MWFONT_ARIAL_UNICODE_ENABLE 1
#endif

#ifdef MWFONT_FIXED_MEDIUM_ENABLE
#define MWFONT_FIXED_MEDIUM "Misc-Fixed-Medium" // font -Misc-Fixed-Medium-R-SemiCondensed --13-120-75-75-C-60-ISO10646-1 from 6x13.c
#endif

#ifdef MWFONT_FIXED_MEDIUM_JA_ENABLE
#define MWFONT_FIXED_MEDIUM_JA  "Misc-Fixed-MediumJa" //name: -Misc-Fixed-Medium-R-Normal -ja-13-120-75-75-C-120-ISO10646-1 from 12x13ja.c
#endif

#ifdef MWFONT_METRIX_SYMBOLS_ENABLE
#define MWFONT_METRIX_SYMBOLS  "Metrix-Symbols" //name: -Metrix-Symbols  from _8x13_MetrixSymbols.c
#endif

#ifdef MWFONT_VERA_ENABLE
#define MWFONT_VERA  "Vera-medium" //name: -FreeType-vera-medium-r-normal--13-130-75-75-P-70-ISO10646-1
#endif

#ifdef MWFONT_VERA_BD_ENABLE
#define MWFONT_VERA_BD  "Vera-medium-Bd" //name: -FreeType-vera-medium-r-normal--13-130-75-75-P-79-ISO10646-1
#endif

#ifdef MWFONT_ARIAL_UNICODE_ENABLE
#define MWFONT_ARIAL_UNICODE  "Arial-Unicode" //name: FreeType-arialUnicode-medium-r-normal--16-150-75-75-P-136-ISO10646-16 fromm arailUnicode15.c
#endif
