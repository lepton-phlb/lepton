...
static const char *_getopt_initialize (getopt_state_t* getopt_state, int argc, char *const * argv, const char *optstring)
{
...
int _getopt_internal (getopt_state_t* getopt_state, int argc, char *const *argv, const char *optstring, 
	const struct option *longopts, int *longind, int long_only)
{
...
int getopt_long_only (getopt_state_t* getopt_state, int argc, char *const *argv, const char *options, 
	const struct option *long_options, int *opt_index)
{
