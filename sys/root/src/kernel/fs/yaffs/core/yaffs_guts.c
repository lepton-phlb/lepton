...
const char *yaffs_guts_c_version =
    "$Id: yaffs_guts.c,v 1.1 2010-05-31 13:44:39 phlb Exp $";
...
/*phlb static*/ int yaffs_UnlinkObject(yaffs_Object *obj);
...
#endif
#ifndef CONFIG_YAFFS_WINCE
	yaffs_CheckStruct(yaffs_ObjectHeader, 512 /*512 phlb:see data alignemnt 510 for 1 byte */, "yaffs_ObjectHeader");
#endif
	return YAFFS_OK;
}
