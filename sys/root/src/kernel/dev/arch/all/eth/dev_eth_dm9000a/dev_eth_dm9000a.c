...
#elif defined(USE_ECOS)
   {
      cyg_interrupt_create((cyg_vector_t)g_board_info.irq_no, (cyg_priority_t)g_board_info.irq_prio, 0,
               (p_dev_io_info->p_fct_isr?p_dev_io_info->p_fct_isr:&dev_eth_dm9000a_interrupt_isr),
