...
#define REG_RTC_TCR_TCR(x)                           (((uint32_t)(((uint32_t)(x))<<REG_RTC_TCR_TCR_SHIFT))&REG_RTC_TCR_TCR_MASK)
#define REG_RTC_TCR_CIR_MASK                         0xFF00u
#define REG_RTC_TCR_CIR_SHIFT                        8
#define REG_RTC_TCR_CIR(x)                           (((uint32_t)(((uint32_t)(x))<<REG_RTC_TCR_CIR_SHIFT))&REG_RTC_TCR_CIR_MASK)
#define REG_RTC_TCR_TCV_MASK                         0xFF0000u
#define REG_RTC_TCR_TCV_SHIFT                        16
#define REG_RTC_TCR_TCV(x)                           (((uint32_t)(((uint32_t)(x))<<REG_RTC_TCR_TCV_SHIFT))&REG_RTC_TCR_TCV_MASK)
#define REG_RTC_TCR_CIC_MASK                         0xFF000000u
#define REG_RTC_TCR_CIC_SHIFT                        24
#define REG_RTC_TCR_CIC(x)                           (((uint32_t)(((uint32_t)(x))<<REG_RTC_TCR_CIC_SHIFT))&REG_RTC_TCR_CIC_MASK)
