...
#define REG_DMA_SADDR_SADDR(x)                       (((uint32_t)(((uint32_t)(x))<< \
                                                                  REG_DMA_SADDR_SADDR_SHIFT))& \
                                                      REG_DMA_SADDR_SADDR_MASK)

//
#define REG_DMA_SOFF_SOFF_MASK                       0xFFFFu
#define REG_DMA_SOFF_SOFF_SHIFT                      0
#define REG_DMA_SOFF_SOFF(x)                         (((uint16_t)(((uint16_t)(x))<< \
                                                                  REG_DMA_SOFF_SOFF_SHIFT))& \
                                                      REG_DMA_SOFF_SOFF_MASK)

//
#define REG_DMA_ATTR_DSIZE_MASK                      0x7u
#define REG_DMA_ATTR_DSIZE_SHIFT                     0
#define REG_DMA_ATTR_DSIZE(x)                        (((uint16_t)(((uint16_t)(x))<< \
                                                                  REG_DMA_ATTR_DSIZE_SHIFT))& \
                                                      REG_DMA_ATTR_DSIZE_MASK)
#define REG_DMA_ATTR_DMOD_MASK                       0xF8u
#define REG_DMA_ATTR_DMOD_SHIFT                      3
#define REG_DMA_ATTR_DMOD(x)                         (((uint16_t)(((uint16_t)(x))<< \
                                                                  REG_DMA_ATTR_DMOD_SHIFT))& \
                                                      REG_DMA_ATTR_DMOD_MASK)
#define REG_DMA_ATTR_SSIZE_MASK                      0x700u
#define REG_DMA_ATTR_SSIZE_SHIFT                     8
#define REG_DMA_ATTR_SSIZE(x)                        (((uint16_t)(((uint16_t)(x))<< \
                                                                  REG_DMA_ATTR_SSIZE_SHIFT))& \
                                                      REG_DMA_ATTR_SSIZE_MASK)
#define REG_DMA_ATTR_SMOD_MASK                       0xF800u
#define REG_DMA_ATTR_SMOD_SHIFT                      11
#define REG_DMA_ATTR_SMOD(x)                         (((uint16_t)(((uint16_t)(x))<< \
                                                                  REG_DMA_ATTR_SMOD_SHIFT))& \
                                                      REG_DMA_ATTR_SMOD_MASK)

//
#define REG_DMA_NBYTES_MLNO_NBYTES_MASK              0xFFFFFFFFu
#define REG_DMA_NBYTES_MLNO_NBYTES_SHIFT             0
#define REG_DMA_NBYTES_MLNO_NBYTES(x)                (((uint32_t)(((uint32_t)(x))<< \
                                                                  REG_DMA_NBYTES_MLNO_NBYTES_SHIFT)) \
                                                      &REG_DMA_NBYTES_MLNO_NBYTES_MASK)

//
#define REG_DMA_NBYTES_MLOFFYES_NBYTES_MASK          0x3FFu
#define REG_DMA_NBYTES_MLOFFYES_NBYTES_SHIFT         0
#define REG_DMA_NBYTES_MLOFFYES_NBYTES(x)            (((uint32_t)(((uint32_t)(x))<< \
                                                                  REG_DMA_NBYTES_MLOFFYES_NBYTES_SHIFT)) \
                                                      &REG_DMA_NBYTES_MLOFFYES_NBYTES_MASK)
#define REG_DMA_NBYTES_MLOFFYES_MLOFF_MASK           0x3FFFFC00u
#define REG_DMA_NBYTES_MLOFFYES_MLOFF_SHIFT          10
#define REG_DMA_NBYTES_MLOFFYES_MLOFF(x)             (((uint32_t)(((uint32_t)(x))<< \
                                                                  REG_DMA_NBYTES_MLOFFYES_MLOFF_SHIFT)) \
                                                      &REG_DMA_NBYTES_MLOFFYES_MLOFF_MASK)
...
#define REG_DMA_SLAST_SLAST(x)                       (((uint32_t)(((uint32_t)(x))<< \
                                                                  REG_DMA_SLAST_SLAST_SHIFT))& \
                                                      REG_DMA_SLAST_SLAST_MASK)

//
#define REG_DMA_DADDR_DADDR_MASK                     0xFFFFFFFFu
#define REG_DMA_DADDR_DADDR_SHIFT                    0
#define REG_DMA_DADDR_DADDR(x)                       (((uint32_t)(((uint32_t)(x))<< \
                                                                  REG_DMA_DADDR_DADDR_SHIFT))& \
                                                      REG_DMA_DADDR_DADDR_MASK)

//
#define REG_DMA_DOFF_DOFF_MASK                       0xFFFFu
#define REG_DMA_DOFF_DOFF_SHIFT                      0
#define REG_DMA_DOFF_DOFF(x)                         (((uint16_t)(((uint16_t)(x))<< \
                                                                  REG_DMA_DOFF_DOFF_SHIFT))& \
                                                      REG_DMA_DOFF_DOFF_MASK)

//
#define REG_DMA_CITER_ELINKNO_CITER_MASK             0x7FFFu
#define REG_DMA_CITER_ELINKNO_CITER_SHIFT            0
#define REG_DMA_CITER_ELINKNO_CITER(x)               (((uint16_t)(((uint16_t)(x))<< \
                                                                  REG_DMA_CITER_ELINKNO_CITER_SHIFT)) \
                                                      &REG_DMA_CITER_ELINKNO_CITER_MASK)
...
#define REG_DMA_DLAST_SGA_DLASTSGA(x)                (((uint32_t)(((uint32_t)(x))<< \
                                                                  REG_DMA_DLAST_SGA_DLASTSGA_SHIFT)) \
                                                      &REG_DMA_DLAST_SGA_DLASTSGA_MASK)
...
#define REG_DMA_CSR_MAJORLINKCH(x)                   (((uint16_t)(((uint16_t)(x))<< \
                                                                  REG_DMA_CSR_MAJORLINKCH_SHIFT))& \
                                                      REG_DMA_CSR_MAJORLINKCH_MASK)
#define REG_DMA_CSR_BWC_MASK                         0xC000u
#define REG_DMA_CSR_BWC_SHIFT                        14
#define REG_DMA_CSR_BWC(x)                           (((uint16_t)(((uint16_t)(x))<< \
                                                                  REG_DMA_CSR_BWC_SHIFT))& \
                                                      REG_DMA_CSR_BWC_MASK)

//
#define REG_DMA_BITER_ELINKNO_BITER_MASK             0x7FFFu
#define REG_DMA_BITER_ELINKNO_BITER_SHIFT            0
#define REG_DMA_BITER_ELINKNO_BITER(x)               (((uint16_t)(((uint16_t)(x))<< \
                                                                  REG_DMA_BITER_ELINKNO_BITER_SHIFT)) \
                                                      &REG_DMA_BITER_ELINKNO_BITER_MASK)
