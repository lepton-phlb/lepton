...
#define REG_ENET_MMFR_ST(x)			(((unsigned int)(((unsigned int)(x))<<REG_ENET_MMFR_ST_SHIFT))&REG_ENET_MMFR_ST_MASK)	
#define REG_ENET_MMFR_OP_MASK		(0x30000000)
#define REG_ENET_MMFR_OP_SHIFT		28
#define REG_ENET_MMFR_OP(x)			(((unsigned int)(((unsigned int)(x))<<REG_ENET_MMFR_OP_SHIFT))&REG_ENET_MMFR_OP_MASK)
#define REG_ENET_MMFR_PA_MASK		(0xF800000)
#define REG_ENET_MMFR_PA_SHIFT		23
#define REG_ENET_MMFR_PA(x)			(((unsigned int)(((unsigned int)(x))<<REG_ENET_MMFR_PA_SHIFT))&REG_ENET_MMFR_PA_MASK)
#define REG_ENET_MMFR_RA_MASK		(0x7C0000)
#define REG_ENET_MMFR_RA_SHIFT		18
#define REG_ENET_MMFR_RA(x)			(((unsigned int)(((unsigned int)(x))<<REG_ENET_MMFR_RA_SHIFT))&REG_ENET_MMFR_RA_MASK)
#define REG_ENET_MMFR_TA_MASK		(0x30000)
#define REG_ENET_MMFR_TA_SHIFT		16
#define REG_ENET_MMFR_TA(x)			(((unsigned int)(((unsigned int)(x))<<REG_ENET_MMFR_TA_SHIFT))&REG_ENET_MMFR_TA_MASK)
#define REG_ENET_MMFR_DATA_MASK		(0xFFFF)
#define REG_ENET_MMFR_DATA_SHIFT	0
#define REG_ENET_MMFR_DATA(x)		(((unsigned int)(((unsigned int)(x))<<REG_ENET_MMFR_DATA_SHIFT))&REG_ENET_MMFR_DATA_MASK)

//MSCR bits fields
#define REG_ENET_MSCR_HOLDTIME_MASK			(0x700)
#define REG_ENET_MSCR_HOLDTIME_SHIFT		8
#define REG_ENET_MSCR_HOLDTIME(x)			(((unsigned int)(((unsigned int)(x))<<REG_ENET_MSCR_HOLDTIME_SHIFT))&REG_ENET_MSCR_HOLDTIME_MASK)
#define REG_ENET_MSCR_DIS_PRE_MASK         	(0x80)
#define REG_ENET_MSCR_MII_SPEED_MASK		(0x7E)
#define REG_ENET_MSCR_MII_SPEED_SHIFT		1
#define REG_ENET_MSCR_MII_SPEED(x)			(((unsigned int)(((unsigned int)(x))<<REG_ENET_MSCR_MII_SPEED_SHIFT))&REG_ENET_MSCR_MII_SPEED_MASK)
...
#define REG_ENET_RCR_MAX_FL(x)			(((unsigned int)(((unsigned int)(x))<<REG_ENET_RCR_MAX_FL_SHIFT))&REG_ENET_RCR_MAX_FL_MASK)
...
#define REG_ENET_TCR_ADDSEL(x)			(((unsigned int)(((unsigned int)(x))<<REG_ENET_TCR_ADDSEL_SHIFT))&REG_ENET_TCR_ADDSEL_MASK)
...
#define REG_ENET_PALR_PADDR1(x)			(((unsigned int)(((unsigned int)(x))<<REG_ENET_PALR_PADDR1_SHIFT))&REG_ENET_PALR_PADDR1_MASK)

//PAUR bits fields
#define REG_ENET_PAUR_PADDR2_MASK		(0xFFFF0000)
#define REG_ENET_PAUR_PADDR2_SHIFT		16
#define REG_ENET_PAUR_PADDR2(x)			(((unsigned int)(((unsigned int)(x))<<REG_ENET_PAUR_PADDR2_SHIFT))&REG_ENET_PAUR_PADDR2_MASK)
#define REG_ENET_PAUR_TYPE_MASK			(0xFFFF)
#define REG_ENET_PAUR_TYPE_SHIFT		0
#define REG_ENET_PAUR_TYPE(x)			(((unsigned int)(((unsigned int)(x))<<REG_ENET_PAUR_TYPE_SHIFT))&REG_ENET_PAUR_TYPE_MASK)

//OPD bits fields
#define REG_ENET_OPD_OPCODE_MASK		(0xFFFF0000)
#define REG_ENET_OPD_OPCODE_SHIFT		16
#define REG_ENET_OPD_OPCODE(x)			(((unsigned int)(((unsigned int)(x))<<ENET_OPD_OPCODE_SHIFT))&ENET_OPD_OPCODE_MASK)
#define REG_ENET_OPD_PAUSE_DUR_MASK		(0xFFFF)
#define REG_ENET_OPD_PAUSE_DUR_SHIFT	0
#define REG_ENET_OPD_PAUSE_DUR(x)		(((unsigned int)(((unsigned int)(x))<<REG_ENET_OPD_PAUSE_DUR_SHIFT))&REG_ENET_OPD_PAUSE_DUR_MASK)

//IAUR Bit Fields
#define REG_ENET_IAUR_IADDR1_MASK		(0xFFFFFFFF)
#define REG_ENET_IAUR_IADDR1_SHIFT     	0
#define REG_ENET_IAUR_IADDR1(x)			(((unsigned int)(((unsigned int)(x))<<REG_ENET_IAUR_IADDR1_SHIFT))&REG_ENET_IAUR_IADDR1_MASK)

//IALR Bit Fields
#define REG_ENET_IALR_IADDR2_MASK		(0xFFFFFFFF)
#define REG_ENET_IALR_IADDR2_SHIFT		0
#define REG_ENET_IALR_IADDR2(x)			(((unsigned int)(((unsigned int)(x))<<REG_ENET_IALR_IADDR2_SHIFT))&REG_ENET_IALR_IADDR2_MASK)

//GAUR Bit Fields
#define REG_ENET_GAUR_GADDR1_MASK		(0xFFFFFFFF)
#define REG_ENET_GAUR_GADDR1_SHIFT		0
#define REG_ENET_GAUR_GADDR1(x)			(((unsigned int)(((unsigned int)(x))<<REG_ENET_GAUR_GADDR1_SHIFT))&REG_ENET_GAUR_GADDR1_MASK)

//GALR Bit Fields
#define REG_ENET_GALR_GADDR2_MASK		(0xFFFFFFFF)
#define REG_ENET_GALR_GADDR2_SHIFT		0
#define REG_ENET_GALR_GADDR2(x)			(((unsigned int)(((unsigned int)(x))<<REG_ENET_GALR_GADDR2_SHIFT))&REG_ENET_GALR_GADDR2_MASK)

//TFWR Bit Fields
#define REG_ENET_TFWR_STRFWD_MASK		(0x100)
#define REG_ENET_TFWR_TFWR_MASK			(0x3F)
#define REG_ENET_TFWR_TFWR_SHIFT		0
#define REG_ENET_TFWR_TFWR(x)			(((unsigned int)(((unsigned int)(x))<<REG_ENET_TFWR_TFWR_SHIFT))&REG_ENET_TFWR_TFWR_MASK)

//RDSR Bit Fields
#define REG_ENET_RDSR_R_DES_START_MASK		(0xFFFFFFF8)
#define REG_ENET_RDSR_R_DES_START_SHIFT		3
#define REG_ENET_RDSR_R_DES_START(x)		(((unsigned int)(((unsigned int)(x))<<REG_ENET_RDSR_R_DES_START_SHIFT))&REG_ENET_RDSR_R_DES_START_MASK)

//TDSR Bit Fields
#define REG_ENET_TDSR_X_DES_START_MASK		(0xFFFFFFF8)
#define REG_ENET_TDSR_X_DES_START_SHIFT	3
#define REG_ENET_TDSR_X_DES_START(x)		(((unsigned int)(((unsigned int)(x))<<REG_ENET_TDSR_X_DES_START_SHIFT))&REG_ENET_TDSR_X_DES_START_MASK)

//MRBR Bit Fields
#define REG_ENET_MRBR_R_BUF_SIZE_MASK		(0x3FF0)
#define REG_ENET_MRBR_R_BUF_SIZE_SHIFT		4
#define REG_ENET_MRBR_R_BUF_SIZE(x)			(((unsigned int)(((unsigned int)(x))<<REG_ENET_MRBR_R_BUF_SIZE_SHIFT))&REG_ENET_MRBR_R_BUF_SIZE_MASK)
