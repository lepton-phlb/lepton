...
static unsigned char _at91sam9261_endpoint_rcv_buffer[AT91SAM9261_RCV_BUFFER]__attribute__ ((section (".no_cache")))={0};
...
static unsigned char *_at91sam9261_ep_input_pbegin[AT91SAM9261_ENDPOINT_COUNT] __attribute__ ((section (".no_cache"))) = {
      0,
...
static unsigned char *_at91sam9261_ep_input_pend[AT91SAM9261_ENDPOINT_COUNT] __attribute__ ((section (".no_cache"))) =  {
      0,
      _at91sam9261_endpoint_rcv_buffer,
      0,
      0,
...
//data pointers per each endpoints (read)
static unsigned char *_at91sam9261_ep_buffer_pbegin[AT91SAM9261_ENDPOINT_COUNT] __attribute__ ((section (".no_cache"))) = {
      0,
      _at91sam9261_endpoint_rcv_buffer,
      0,
      0,
...
static unsigned char *_at91sam9261_ep_buffer_pend[AT91SAM9261_ENDPOINT_COUNT] __attribute__ ((section (".no_cache"))) =  {
      0,
      _at91sam9261_endpoint_rcv_buffer,
      0,
      0,
...
static unsigned char _at91sam9261_ep_bank1[AT91SAM9261_ENDPOINT_COUNT] __attribute__ ((section (".no_cache"))) = {
      USB_FALSE,
      USB_FALSE,
      USB_FALSE,
      USB_FALSE,
...
static unsigned short _at91sam9261_ep_bytes_in_fifo[AT91SAM9261_ENDPOINT_COUNT] __attribute__ ((section (".no_cache"))) = {
      0,
      0,
      0,
      0,
...
//
static unsigned short _at91sam9261_ep_bytes_received[AT91SAM9261_ENDPOINT_COUNT] __attribute__ ((section (".no_cache"))) = {
...
// end point number
static const void *_at91sam9261_endpoints[AT91SAM9261_ENDPOINT_COUNT] __attribute__ ((section (".no_cache"))) = {
