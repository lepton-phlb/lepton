...
static const unsigned char at91sam9261_lcd_tblum[16] = {255,250,245,240,235,230,225,215,205,195,185,175,165,135,75,5};
...
unsigned long at91sam9261_lcd_switch_active_frame_buffer(void){
   ...
   g_panel_info.controller.lcdc->LCDC_BA1=(unsigned long)p_at91sam9261_frame_buffer[at91sam9261_current_frame_buffer];
...
{
   AT91_SYS->PIOB_PDR = (AT91C_PB0_LCDVSYNC | AT91C_PB1_LCDHSYNC | AT91C_PB2_LCDDOTCK | AT91C_PB3_LCDDEN  |
...
{
   unsigned long size;
   int line_length = ((unsigned int)g_panel_info.vl_col * (unsigned int)NBITS(g_panel_info.vl_bpix)) / 8;
...
int at91sam9261_lcd_ctrl_init (dev_panel_info_t* p_panel_info)
{
   ...
   g_panel_info.controller.frame_buffer = (unsigned long)p_at91sam9261_frame_buffer[at91sam9261_current_frame_buffer];  // sur les registres du controleur LCD
   ...
   value = ((unsigned int)g_panel_info.vl_row * (unsigned int)g_panel_info.vl_col * (unsigned int)NBITS(g_panel_info.vl_bpix)) / 32;
   ...
   // Set contrast
   value = AT91C_LCDC_PS_DIVIDEDBYEIGHT | AT91C_LCDC_POL_NEGATIVEPULSE | AT91C_LCDC_ENA_PWMGEMENABLED;
   ...
   g_panel_info.controller.lcdc->LCDC_BA1 = (unsigned long)p_at91sam9261_frame_buffer[at91sam9261_current_frame_buffer];
   g_panel_info.controller.lcdc->LCDC_FRMCFG = (SIDSAFB_DMA_BURST_LEN << 24) + ((unsigned int)g_panel_info.vl_col * (unsigned int)g_panel_info.vl_row * (unsigned int)NBITS(g_panel_info.vl_bpix)) / 32;
   /* DMA enable */
