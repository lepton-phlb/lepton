...
#define __resume_snd__()\
   ...
   S0TIC  = 1;\
   /*send buffer byte*/\
   if(_at91m55800a_uart_s0_output_r>=0 && _at91m55800a_uart_s0_output_r<_at91m55800a_uart_s0_output_w){\
      ...
      }else if(_at91m55800a_uart_s0_desc_wr>=0 &&  _at91m55800a_uart_s0_output_r==_at91m55800a_uart_s0_output_w)\
...
void dev_at91m55800a_uart_s0_fifo_pool_rcv(void){
   ...
   //
   if((_at91m55800a_uart_s0_desc_rd>=0) && (_at91m55800a_uart_s0_input_r==_at91m55800a_uart_s0_input_w)){//empty to not empty
      //profiler
...
void dev_at91m55800a_uart_s0_interrupt(void)
{
  __AIC_IVR = 0; // Debug variant of vector read, protected mode is used.
   if(dev_at91m55800a_uart_s0_loaded){
      ...
      } while ( (_usart_csr & __US_IMR & (0x00000108)) || ( (XMIT) && (_usart_csr & __US_IMR & (IER_MASK_SND)) ) ); 
...
void dev_at91m55800a_uart_s0_dsr(cyg_vector_t vector, cyg_ucount32 count, cyg_addrword_t data)
{
	...
	if(_at91m55800a_uart_s0_desc_wr>=0 && _at91m55800a_uart_s0_output_r==_at91m55800a_uart_s0_output_w){
		__fire_io_int(ofile_lst[_at91m55800a_uart_s0_desc_wr].owner_pthread_ptr_write);
	}
