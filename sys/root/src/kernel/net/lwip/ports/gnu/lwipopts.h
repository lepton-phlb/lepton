...
#define LWIP_DNS                   1
//add for dns
#define DNS_SERVER_ADDRESS         inet_addr("14.2.100.5")
#define DNS_USES_STATIC_BUF        0 //2
...
#else
   #define MEMP_NUM_TCP_PCB        24 //10//5
#endif
...
#else
   #define MEMP_NUM_NETCONN        48 //15//10
#endif
...
//dummy test
//#define IP_TMR_INTERVAL    ((1000+9)/10)
//#define ARP_TMR_INTERVAL   ((5000+9)/10)
//#define IGMP_TMR_INTERVAL  ((100+9)/10)
//#define DNS_TMR_INTERVAL   ((1000+9)/10)
//#define TCP_TMR_INTERVAL   ((250+9)/10)
//

#if MEM_LIBC_MALLOC
   #include <stdlib.h> //lepton modification:see lwip/include/lwip/mem.h (see definitions of mem_free, mem_alloc, ...)
#endif
