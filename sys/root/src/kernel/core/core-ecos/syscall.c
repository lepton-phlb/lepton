...
| Revision 1.10  2010/02/12 14:45:16  jjp
| add sem_init and sem_destroy syscall + bugfix on ioctl
|
| Revision 1.9  2010/02/08 09:26:42  phlb
| support new kernel object manager interface and new read/write io semaphore.
|
| Revision 1.8  2009/11/13 12:05:02  jjp
| improve waitpid function
| add 2 functions _sys_pthread_cancel_for_exit, _sys_do_waitpid
|
| Revision 1.7  2009/07/06 10:05:16  jjp
| bug fix from phlb 3.0.0.8
|
| Revision 1.6  2009/07/02 08:52:45  jjp
| bug fix from phlb 3.0.0.7
|
| Revision 1.5  2009/07/01 16:58:55  phlb
