...
static int  _sys_lwip_lowlevel_write(lwip_sock_t *sock, const void *data, int size, unsigned int flags);
static int  _sys_lwip_lowlevel_writeto(lwip_sock_t *sock, void *data, int size, unsigned int flags,struct sockaddr *to, socklen_t tolen);
...
int _sys_lwip_socket(int domain, int type, int protocol){
   ...
   switch (type) {
   case SOCK_RAW:
    conn = netconn_new_with_proto_and_callback(NETCONN_RAW, protocol, _sys_lwip_sock_event_callback);
...
| See:
----------------------------------------------*/
int _sys_lwip_recvfrom(int fd, void *mem, int len, unsigned int flags,struct sockaddr *from, socklen_t *fromlen){
...
| See:
----------------------------------------------*/
int _sys_lwip_sendto(int fd,void *data, int size, unsigned int flags,struct sockaddr *to, socklen_t tolen){
